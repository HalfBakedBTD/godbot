...
client.on('message', async msg => { // eslint-disable-line
	...
	if (command === 'play'||command === 'p') {
		...
		if (!voiceChannel) return msg.channel.send('<:4366_RedTick:558281890964963368> Make sure your in a voice channel');
...
function play(guild, song) {
	...
	serverQueue.textChannel.send(`<:5727_GreenTick:558281961031073801> Now Playing **${song.title}**\nRequested By: [<@${song.requestedby.id}>]`);
}
