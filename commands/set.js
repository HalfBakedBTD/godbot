...
if(cmd === "levelSystem"){
if(!args.toLowerCase().startsWith('on') && !args.toLowerCase().startsWith('off')) return message.channel.send("Off or On");  
  ...
  message.channel.send(`Succesfully \`Disabled\` the levelSystem for this sever`);
  }
}
